...
public class CamelotFoodInfoDAO implements DAO<Manufacturer> {
    private SQLiteDatabase sqLiteDatabase;
    private static final String TAG = AztecaInfoDAO.class.getSimpleName();

    public CamelotFoodInfoDAO(SQLiteDatabase sqLiteDatabase) {
        this.sqLiteDatabase = sqLiteDatabase;
    }

    @Override
    public void save(Manufacturer manufacturer) {
        sqLiteDatabase.insert(Resource.Manufacturer.TABLE_NAME_CAMELOTFOOD_INFO, null, manufacturerContentValues(manufacturer));
    ...
    public List<Manufacturer> getAll() {
        Cursor cursor = sqLiteDatabase.rawQuery(
                "select * from "
                        + Resource.Manufacturer.TABLE_NAME_CAMELOTFOOD_INFO,
                null);
    ...
    public void deleteAll() {
        sqLiteDatabase.execSQL("delete from " + Resource.Manufacturer.TABLE_NAME_CAMELOTFOOD_INFO);
    ...
    public void deleteById(int id) {
        sqLiteDatabase.execSQL("delete from " + Resource.Manufacturer.TABLE_NAME_CAMELOTFOOD_INFO + " where "
    ...
    public List<Manufacturer> parseCursor(Cursor cursor) {
        ...
        if(cursor != null && cursor.moveToFirst()) {
            do {
                ...
                manufacturers.add(new Manufacturer(id, address, null, logoSrc,
                        kyivstar, vodafone, null, null));
