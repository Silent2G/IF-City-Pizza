...
public class PizzaIFInfoDAO implements DAO<Manufacturer> {

    private SQLiteDatabase sqLiteDatabase;
    private static final String TAG = PizzaIFInfoDAO.class.getSimpleName();

    public PizzaIFInfoDAO(SQLiteDatabase sqLiteDatabase) {
        this.sqLiteDatabase = sqLiteDatabase;
    }

    @Override
    public void save(Manufacturer manufacturer) {
        sqLiteDatabase.insert(Resource.Manufacturer.TABLE_NAME_PIZZAIF_INFO, null, manufacturerContentValues(manufacturer));
    ...
    public List<Manufacturer> getAll() {
        Cursor cursor = sqLiteDatabase.rawQuery(
                "select * from "
                        + Resource.Manufacturer.TABLE_NAME_PIZZAIF_INFO,
                null);
    ...
    public void deleteAll() {
        sqLiteDatabase.execSQL("delete from " + Resource.Manufacturer.TABLE_NAME_PIZZAIF_INFO);
    ...
    public void deleteById(int id) {
        sqLiteDatabase.execSQL("delete from " + Resource.Manufacturer.TABLE_NAME_PIZZAIF_INFO + " where "
