...
public class AztecaDAO implements DAO<Pizza> {
    private SQLiteDatabase sqLiteDatabase;
    private static final String TAG = AztecaDAO.class.getSimpleName();

    public AztecaDAO(SQLiteDatabase sqLiteDatabase) {
        this.sqLiteDatabase = sqLiteDatabase;
    }

    @Override
    public void save(Pizza pizza) {
        sqLiteDatabase.insert(Resource.Pizza.TABLE_NAME_AZTECA_COLLECTION, null, pizzaContentValues(pizza));
    ...
    private ContentValues pizzaContentValues(Pizza pizza) {
        ...
        contentValues.put(Resource.Pizza.PRICELARGE, pizza.getPriceLarge());
        contentValues.put(Resource.Pizza.DIAMETERSTANDART, pizza.getDiameterStandart());
        contentValues.put(Resource.Pizza.DIAMETERLARGE, pizza.getDiameterLarge());
    ...
    public List<Pizza> getAll() {
        Cursor cursor = sqLiteDatabase.rawQuery(
                "select * from "
                        + Resource.Pizza.TABLE_NAME_AZTECA_COLLECTION,
                null);
    ...
    public void deleteAll() {
        sqLiteDatabase.execSQL("delete from " + Resource.Pizza.TABLE_NAME_AZTECA_COLLECTION);
    ...
    public void deleteById(int id) {
        sqLiteDatabase.execSQL("delete from " + Resource.Pizza.TABLE_NAME_AZTECA_COLLECTION + " where "
    ...
    public List<Pizza> parseCursor(Cursor cursor) {
        ...
        if(cursor != null && cursor.moveToFirst()) {
            do {
                ...
                String priceLarge = cursor.getString(cursor.getColumnIndex(Resource.Pizza.PRICELARGE));
                String diameterStandart = cursor.getString(cursor.getColumnIndex(Resource.Pizza.DIAMETERSTANDART));
                String diameterLarge = cursor.getString(cursor.getColumnIndex(Resource.Pizza.DIAMETERLARGE));
                ...
                pizzas.add(new Pizza(id, title, null, priceStandart,
                        priceLarge, diameterStandart, diameterLarge, description, imageSrc));
